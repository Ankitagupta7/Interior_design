<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Forgotpassword.aspx.cs" Inherits="Interior_design.Forgotpassword" %>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="submit-button text-center">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn-success btn-block" OnClick="Button1_Click" Width="100%" />
							</div>
						</div>
                        <div class="col-md-12">
