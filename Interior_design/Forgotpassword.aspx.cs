    ...
    public partial class Forgotpassword : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (con.State == ConnectionState.Closed)
                con.Open();
            SqlCommand checkemail = new SqlCommand("select email from [Register] where email = @email and is_active=1", con);
            ...
            if (read.HasRows)
            {
                ...
                string qr = "update [Register] set fotgototp='" + fotgototpOTP + "' where email='" + email.Text.ToString() + "'";
                ...
                emailBody += "<p><a href='" + "http://localhost:53733/resetPassword.aspx?forgototp=" + forgototp + "&email=" + email.Text.Trim() + "'>Click here to reset password.</a></p>";
                ...
                emailBody += "<p>&nbsp;</p>";
                emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:22px;margin:0px;font-weight:bold'>Support by,</p>";
