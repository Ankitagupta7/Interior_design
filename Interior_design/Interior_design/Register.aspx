<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Interior_design.Register" %>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="heading-title text-center">
					...
					<div class="col-md-6 d-flex justify-content-center flex-column align-items-center w-50 p-3">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="submit-button text-center">
								<asp:Button ID="Button1" runat="server" Text="Register" CssClass="btn-success btn-block" OnClick="Button1_Click" Width="100%" />
