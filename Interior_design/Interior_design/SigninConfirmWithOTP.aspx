<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SigninConfirmWithOTP.aspx.cs" Inherits="Interior_design.SigninConfirmWithOTP" %>
			...
			<div class="col-lg-12">
				<div class="heading-title text-center">
					...
					<div class="col-md-6 d-flex justify-content-center flex-column align-items-center w-100 p-3">
						...
						<h2 class="font-weight-bold">Signin With OTP</h2>
					</div>
			   ...
			   <%--<form id="contactForm">--%>
				<div class="row">
				   <asp:Label ID="lblErrorMsg" runat="server" Text=""></asp:Label>
					 ...
					 <div class="col-md-12">
                         <asp:Button ID="Button1" runat="server" Text="Submit" CssClass="btn-success btn-block" Width="100%" OnClick="Button1_Click" />
					  <div class="form-group">
