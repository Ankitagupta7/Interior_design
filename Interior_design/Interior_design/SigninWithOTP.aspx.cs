    ...
    public partial class SigninWithOTP : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (read.HasRows)
            {
                ...
                string qr = "update [Register] set signinotp='" + mySigninOTP + "', otp_created='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "' where email='" + email.Text.ToString() + "'";
                ...
                emailBody += "<p><a href='" + "http://localhost:53733/SigninConfirmWithOTP.aspx?email=" + email.Text.Trim() + "'>Click here to Signin your account.</a></p>";
