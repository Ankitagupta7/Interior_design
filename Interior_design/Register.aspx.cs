        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (captchaCode.Text.ToLower() == Session["sessionCaptcha"].ToString())
            {
                ...
                else
                {
                    ...
                    con.Open();
                    string insertUsr = "INSERT INTO [Register] (first_name, last_name, email, contact, City, Address, password, gender, is_active, photo, created_on, activation_code, activation_code_time) " +
                   "VALUES (@first_name, @last_name, @email, @contact, @City, @Address, @password, @gender, @is_active, @photo, @created_on, @activation_code, @activation_code_time)";
                    ...
                    emailBody += "<tbody>";
                    emailBody += "<tr>";
                    emailBody += "<td valign='top' style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;background:linear-gradient(to bottom, #0f0c29, #302b63, #28286a);color:#fff;'>";
                    ...
                    emailBody += "<div style='clear:both;width:100%;text-align:center;font-size:11px;font-style:italic;'>&nbsp;&nbsp;&nbsp;&nbsp;DecorDreams!</div>";
                    emailBody += "</div>";
                    emailBody += "</div>";
                    emailBody += "</td>";
                    emailBody += "</tr>";
                    ...
                    emailBody += "<p><a href='" + "http://localhost:53733/ActivateAccount.aspx?activation_code=" + activation_code + "&email=" + Base64Encode(email.Text.Trim()) + "'>Click here to activate your account.</a></p>";
                    ...
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;color:rgb(41,41,41);line-height:22px;margin:0px'>Ankita Gupta </p>";
                    emailBody += "</td>";
                    emailBody += "</tr>";
                    emailBody += "</tbody>";
                    emailBody += "</table>";
                    ...
                    smtp.Credentials = new System.Net.NetworkCredential("akguptaankita15@gmail.com", "nhrh hpxb zyby vbwg");
                    smtp.Send(mail);
                    //}
                    ...
                    lblErrorMsg.Text = "Your are registered successfully the activation Code is send in your mail.";
