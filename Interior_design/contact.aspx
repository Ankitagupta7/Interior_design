<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Interior_design.contact" %>
...
<div class="hero">
    <div class="container">
	    <div class="row">
		    ...
		    <h2 class="section-title">CONTACT TO A DESIGNER</h2>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary-hover-outline"><a href="Signin.aspx">Send Message</a></button>
...
<style>
    .hero{
background-image: url('images/source/book-background.jpg'); 
